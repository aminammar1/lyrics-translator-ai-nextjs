    ...
    console.log('Making request to Genius API for query:', query)

    try {
        const url = `https://api.genius.com/search?q=${encodeURIComponent(query)}&per_page=3`
        ...
        console.error('Error in quick search API:', {
