...
export default function SongPage({ song, loading }: SongProps) {
  if (loading || !song.id) {
    return (
      <div className="w-fit mx-auto mt-28 lg:mt-24">
        <Loader width={32} />
      </div>
    )
  }
  ...
  return (
    <div className="mx-[20px] z-[100] mt-28 lg:mt-24">
      <div className="min-w-[332px] w-[50vw] max-w-[760px] mx-auto bg-black/50 p-[20px] shadow-foreground shadow-inner rounded-[15px]">
        ...
        <h3 className="text-center text-xl opacity-50">{song.artist_name}</h3>
